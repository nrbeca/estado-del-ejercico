...
CATALOGO_PARTIDAS = {
    ...
    '21199': 'Materiales de administración, emisión de documentos y artículos oficiales (Solo Ramo 35)',
    ...
    '21801': 'Materiales para el registro e identificación de bienes y personas (Ramos Autónomos)',
    ...
    '22199': 'Alimentos y utensilios (Solo Ramo 35)',
    ...
    '23199': 'Materias primas y materiales de producción y comercialización (Solo Ramo 35)',
    ...
    '24199': 'Materiales y artículos de construcción y de reparación (Solo Ramo 35)',
    ...
    '25199': 'Productos químicos, farmacéuticos y de laboratorio (Solo Ramo 35)',
    ...
    '26199': 'Combustibles, lubricantes y aditivos (Solo Ramo 35)',
    '27101': 'Vestuario y uniformes',
    '27199': 'Vestuario, blancos, prendas de protección y artículos deportivos (Solo Ramo 35)',
    ...
    '28199': 'Materiales y suministros para seguridad (Solo Ramo 35)',
    ...
    '29199': 'Herramientas, refacciones y accesorios menores (Solo Ramo 35)',
    ...
    '31199': 'Servicios básicos (Solo Ramo 35)',
    ...
    '31702': 'Servicios de Procesamiento de Información',
    ...
    '32199': 'Servicios de arrendamiento (Solo Ramo 35)',
    ...
    '33106': 'Servicios legales, de contabilidad, auditoría y relacionados (Ramos Autónomos)',
    '33199': 'Servicios profesionales, científicos, técnicos y otros servicios (Solo Ramo 35)',
    ...
    '33906': 'Asignaciones para cubrir el pago de obligaciones derivadas de títulos de concesión o de asignación',
    '34101': 'Servicios bancarios y financieros',
    '34199': 'Servicios financieros, bancarios y comerciales (Solo Ramo 35)',
    ...
    '34901': 'Otros servicios financieros, bancarios y comerciales (Ramos Autónomos)',
    ...
    '35199': 'Servicios de instalación, reparación, mantenimiento y conservación (Solo Ramo 35)',
    ...
    '36199': 'Servicios de comunicación social y publicidad (Solo Ramo 35)',
    '36201': 'Difusión de mensajes comerciales para promover la venta de productos o servicios',
    '36301': 'Servicios de creatividad, preproducción y producción de publicidad, excepto internet (Ramos Autónomos)',
    '36401': 'Servicios de revelado de fotografías (Ramos Autónomos)',
    '36601': 'Servicio de creación y difusión de contenido exclusivamente a través de Internet (Ramos Autónomos)',
    ...
    '37102': 'Pasajes aéreos nacionales asociados a los programas de seguridad pública y nacional',
    ...
    '37105': 'Pasajes aéreos internacionales asociados a los programas de seguridad pública y nacional',
    '37106': 'Pasajes aéreos internacionales para servidores públicos en el desempeño de comisiones y funciones oficiales',
    '37199': 'Servicios de traslado y viáticos (Solo Ramo 35)',
    '37201': 'Pasajes terrestres nacionales para labores en campo y de supervisión',
    '37202': 'Pasajes terrestres nacionales asociados a los programas de seguridad pública y nacional',
    ...
    '37205': 'Pasajes terrestres internacionales asociados a los programas de seguridad pública y nacional',
    ...
    '37302': 'Pasajes marítimos, lacustres y fluviales asociados a los programas de seguridad pública y nacional',
    '37303': 'Pasajes marítimos, lacustres y fluviales asociados a desastres naturales',
    ...
    '37502': 'Viáticos nacionales asociados a los programas de seguridad pública y nacional',
    ...
    '37601': 'Viáticos en el extranjero asociados a los programas de seguridad pública y nacional',
    ...
    '38102': 'Gastos de ceremonial de los titulares de las dependencias y entidades',
    '38103': 'Gastos inherentes a la investidura presidencial',
    '38199': 'Servicios oficiales (Solo Ramo 35)',
    ...
    '39199': 'Otros servicios generales (Solo Ramo 35)',
    ...
    '39903': 'Asignaciones a los grupos parlamentarios (Ramos Autónomos)',
    '39904': 'Participaciones en órganos de gobierno',
    '39905': 'Actividades de coordinación con el Presidente Electo',
    '39906': 'Servicios Corporativos prestados por las Entidades Paraestatales a sus Organismos',
    ...
    '41601': 'Transferencias a entidades empresariales no financieras derivadas de la obtención de derechos',
    ...
    '44107': 'Apoyo a representantes del Poder Legislativo y partidos políticos ante el Consejo General del IFE (Ramos Autónomos)',
    '44108': 'Dietas a consejeros electorales locales y distritales en el año electoral federal (Ramos Autónomos)',
    '44109': 'Apoyo para alimentos a funcionarios de casilla el día de la jornada electoral federal (Ramos Autónomos)',
    '44110': 'Apoyo financiero a consejeros electorales locales y distritales en año electoral federal (Ramos Autónomos)',
    '44199': 'Ayudas sociales (Solo Ramo 35)',
    '44201': 'Otras ayudas para programas de capacitación (Ramos Autónomos)',
    '44401': 'Apoyos a la investigación científica y tecnológica de instituciones académicas y sector público',
    '44402': 'Apoyos a la investigación científica y tecnológica en instituciones sin fines de lucro',
    '44501': 'Apoyo financiero al Comité Nacional de Supervisión y Evaluación y a la Comisión Nacional de Vigilancia locales y distritales del Registro Federal de Electores (Ramos Autónomos)',
    '44502': 'Financiamiento público a partidos políticos y agrupaciones políticas con registro autorizado (Ramos Autónomos)',
    ...
    '46199': 'Transferencias a fideicomisos, mandatos y otros análogos (Solo Ramo 35)',
    '46201': 'Aportaciones a Fideicomisos Públicos del Poder Legislativo (Ramos Autónomos)',
    '46301': 'Aportaciones a fideicomisos públicos del Poder Judicial (Ramos Autónomos)',
    ...
    '47102': 'Transferencias para cuotas y aportaciones a los seguros de retiro, cesantía en edad avanzada y vejez',
    '48101': 'Donativos a instituciones sin fines de lucro',
    '48199': 'Donativos (Solo Ramo 35)',
    ...
    '49199': 'Transferencias al exterior (Solo Ramo 35)',
    '49201': 'Cuotas y aportaciones a organismos internacionales',
    '49202': 'Otras aportaciones internacionales',
    '51101': 'Mobiliario',
    '51199': 'Mobiliario y equipo de administración (Solo Ramo 35)',
    ...
    '52199': 'Mobiliario y equipo educacional y recreativo (Solo Ramo 35)',
    ...
    '53199': 'Equipo e instrumental médico y de laboratorio (Solo Ramo 35)',
    '53201': 'Instrumental médico y de laboratorio',
    '54101': 'Vehículos y equipo terrestres, para la ejecución de programas de seguridad pública y nacional',
    ...
    '54105': 'Vehículos y equipo terrestres, destinados a servidores públicos',
    '54199': 'Vehículos y equipo de transporte (Solo Ramo 35)',
    ...
    '54302': 'Vehículos y equipo aéreos, destinados exclusivamente para desastres naturales',
    '54303': 'Vehículos y equipo aéreos, destinados a servicios públicos y la operación de programas públicos',
    '54401': 'Equipo ferroviario',
    '54501': 'Vehículos y equipo marítimo, para la ejecución de programas de seguridad pública y nacional',
    '54502': 'Vehículos y equipo marítimo, destinados a servicios públicos y la operación de programas públicos',
    ...
    '55199': 'Equipo de defensa y seguridad (Solo Ramo 35)',
    '56101': 'Maquinaria y equipo agropecuario',
    '56199': 'Maquinaria, otros equipos y herramientas (Solo Ramo 35)',
    ...
    '57199': 'Activos biológicos (Solo Ramo 35)',
    '57201': 'Porcinos',
    '57301': 'Aves',
    ...
    '58101': 'Terrenos',
    '58199': 'Bienes inmuebles (Solo Ramo 35)',
    '58301': 'Edificios y locales',
    '58901': 'Adjudicaciones, expropiaciones e indemnizaciones de inmuebles',
    '58902': 'Bienes inmuebles en la modalidad de proyectos de infraestructura productiva de largo plazo',
    '58903': 'Bienes inmuebles por arrendamiento financiero',
    '58904': 'Otros bienes inmuebles',
    '59101': 'Software',
    '59199': 'Activos intangibles (Solo Ramo 35)',
    '59401': 'Derechos (Ramos Autónomos)',
    '59701': 'Licencias informáticas e intelectuales (Ramos Autónomos)',
    '59901': 'Otros activos intangibles (Ramos Autónomos)',
    '61201': 'Edificación no habitacional (Ramos Autónomos)',
    '61701': 'Instalaciones y equipamiento en construcciones (Ramos Autónomos)',
    '62101': 'Obras de construcción para edificios habitacionales',
    '62102': 'Mantenimiento y rehabilitación de edificaciones habitacionales',
    '62199': 'Obra pública en bienes propios (Solo Ramo 35)',
    ...
    '62302': 'Mantenimiento y rehabilitación de obras para el abastecimiento de agua, petróleo, gas, electricidad y telecomunicaciones',
    '62401': 'Obras de preedificación en terrenos de construcción',
    '62402': 'Construcción de obras de urbanización',
    '62403': 'Mantenimiento y rehabilitación de obras de urbanización',
    '62501': 'Construcción de vías de comunicación',
    '62502': 'Mantenimiento y rehabilitación de las vías de comunicación',
    '62601': 'Otras construcciones de ingeniería civil u obra pesada',
    '62602': 'Mantenimiento y rehabilitación de otras obras de ingeniería civil u obras pesadas',
    '62701': 'Instalaciones y obras de construcción especializada',
    '62901': 'Ensamble y edificación de construcciones prefabricadas',
    '62902': 'Obras de terminación y acabado de edificios',
    '62903': 'Servicios de supervisión de obras',
    '62904': 'Servicios para la liberación de derechos de vía',
    '62905': 'Otros servicios relacionados con obras públicas',
    '72401': 'Adquisición de acciones o aumento en la participación estatal de capital en el sector privado con fines de política económica',
    '72501': 'Adquisición de acciones de organismos internacionales',
    '73101': 'Adquisición de bonos',
    '73501': 'Adquisición de obligaciones',
    '73901': 'Fideicomisos para adquisición de títulos de crédito',
    '73902': 'Adquisición de acciones',
    '73903': 'Adquisición de otros valores',
    '74201': 'Créditos directos para actividades productivas otorgados a entidades paraestatales empresariales y no financieras con fines de política económica',
    '74401': 'Créditos directos para actividades productivas otorgados a entidades federativas y municipios con fines de política económica',
    '74501': 'Créditos directos para actividades productivas otorgados al sector privado con fines de política económica',
    '74502': 'Fideicomisos para financiamiento de obras',
    '74503': 'Fideicomisos para financiamientos agropecuarios',
    '74504': 'Fideicomisos para financiamientos industriales',
    '74505': 'Fideicomisos para financiamientos al comercio y otros servicios',
    '74506': 'Fideicomisos para financiamientos de vivienda',
    '75501': 'Inversiones en fideicomisos públicos empresariales y no financieros considerados entidades paraestatales',
    '75601': 'Inversiones en fideicomisos públicos considerados entidades paraestatales',
    '75602': 'Inversiones en mandatos y otros análogos',
    '75901': 'Aportaciones a fideicomisos, mandatos y otros análogos del sector privado',
    '79901': 'Erogaciones contingentes',
    '79902': 'Provisiones para erogaciones especiales',
    '81101': 'Fondo General de Participaciones',
    '81201': 'Fondo de Fomento Municipal',
    '81401': 'Otros conceptos participables de la Federación a entidades federativas',
    ...
    '83118': 'Aportaciones de la Federación a los organismos del Sistema Nacional de Coordinación Fiscal',
    '83401': 'Aportaciones de la federación al sistema de protección social',
    '83501': 'Asignaciones compensatorias a entidades federativas',
    '85101': 'Convenios de reasignación',
    '91101': 'Amortización de la deuda interna con instituciones de crédito',
    '91102': 'Amortización de la deuda interna derivada de proyectos de infraestructura productiva de largo plazo',
    '91201': 'Amortización de la deuda por emisión de valores gubernamentales',
    '91301': 'Amortización de arrendamientos financieros nacionales',
    '91302': 'Amortización de arrendamientos financieros especiales',
    '91401': 'Amortización de la deuda externa con instituciones de crédito',
    '91402': 'Amortización de la deuda externa derivada de proyectos de infraestructura productiva de largo plazo',
    '91501': 'Amortización de la deuda con organismos financieros internacionales',
    '91601': 'Amortización de la deuda bilateral',
    '91701': 'Amortización de la deuda externa por bonos',
    '91801': 'Amortización de arrendamientos financieros internacionales',
    '92101': 'Intereses de la deuda interna con instituciones de crédito',
    '92102': 'Intereses de la deuda interna derivada de proyectos de infraestructura productiva de largo plazo',
    '92201': 'Intereses derivados de la colocación de valores gubernamentales',
    '92301': 'Intereses por arrendamientos financieros nacionales',
    '92302': 'Intereses por arrendamientos financieros especiales',
    '92401': 'Intereses de la deuda externa con instituciones de crédito',
    '92402': 'Intereses de la deuda externa derivada de proyectos de infraestructura productiva de largo plazo',
    '92501': 'Intereses de la deuda con organismos financieros internacionales',
    '92601': 'Intereses de la deuda bilateral',
    '92701': 'Intereses derivados de la colocación externa de bonos',
    '92801': 'Intereses por arrendamientos financieros internacionales',
    '93101': 'Comisiones de la deuda interna',
    '93201': 'Comisiones de la deuda externa',
    '94101': 'Gastos de la deuda interna',
    '94201': 'Gastos de la deuda externa',
    '95101': 'Costo por coberturas',
    '96101': 'Apoyos a intermediarios financieros',
    '96201': 'Apoyos a ahorradores y deudores de la banca',
...
FUSION_URS = {
    "810": "119", "812": "119", "811": "120", "235": "250", "236": "253",
...
def construir_reporte_plantilla(df: pd.DataFrame, fuente: str, mes_corte_idx: int):
    ...
    n_unidades = agregado[filas[0]].nunique()
    if n_unidades > 1:
        # Una fila de Subtotal al final del bloque de cada unidad (además
        # del Total general que ya va arriba de todo).
        bloques = []
        for _, grupo_ur in agregado.groupby(filas[0], sort=True):
            bloques.append(grupo_ur)
            subtotal = {c: "" for c in agregado.columns}
            subtotal[filas[0]] = grupo_ur.iloc[0][filas[0]]
            if len(filas) > 1:
                subtotal[filas[1]] = "Subtotal"
            for c in cols_internas:
                subtotal[c] = grupo_ur[c].sum()
            bloques.append(pd.DataFrame([subtotal]))
        agregado = pd.concat(bloques, ignore_index=True)

    fila_total = {c: "" for c in agregado.columns}
    fila_total[filas[0]] = "Total general"
    col_marca_subtotal = filas[1] if len(filas) > 1 else filas[0]
    solo_datos = agregado[agregado[col_marca_subtotal] != "Subtotal"] if n_unidades > 1 else agregado
    for c in cols_internas:
        fila_total[c] = solo_datos[c].sum()
...
def exportar_excel_oref(pivote: pd.DataFrame, fuente: str, titulo: str, subtitulo: str,
    ...
    col_marca_subtotal = filas[1] if len(filas) > 1 else (filas[0] if filas else None)

    bloque_inicio = None
    for i, (_, fila) in enumerate(pivote.iterrows()):
        r = fila_encabezado + 1 + i
        es_total = str(fila.iloc[0]) == "Total general"
        es_subtotal = (not es_total) and col_marca_subtotal is not None and str(fila.get(col_marca_subtotal, "")) == "Subtotal"
        if not es_total and not es_subtotal and bloque_inicio is None:
            bloque_inicio = r
        ...
        for j, col in enumerate(pivote.columns, start=1):
            ...
            if es_total and es_columna_valor and last_row_num >= first_data_row:
                ...
                col_letra = get_column_letter(j)
                celda.value = f"=SUBTOTAL(9,{col_letra}{bloque_inicio}:{col_letra}{r - 1})"
            elif rol == "disponible":
